...
router.get('/:PostId', check_post_exists_1.default, posts_controller_1.get_specific_post);
router.get('/user/:UserId', check_user_exists_1.default, posts_controller_1.get_user_posts);
